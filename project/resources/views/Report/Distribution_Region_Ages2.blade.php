...
<div dir="ltr">
    ...
    <body class="st_body">
        ...
        <div style="width:1000px; margin: auto;" class="text-center">
            ...
            <table width="734" height="97" cellpadding="0" cellspacing="0">
                <tr>
                    <th height="31" scope="col" class="p-3 mb-2 bg-success text-white" style="border: none;"><span
                            class="style24">59-20</span></th>
                    <th scope="col" class="p-3 mb-2 bg-success text-white" style="border: none;"><span
                            class="style24">19-5</span></th>
                    <th width="141" scope="col" class="p-3 mb-2 bg-success text-white" style="border: none;"><span
                            class="style24">4-0</span></th>
            ...
            <p></p>
            <p></p>
            <table width="540" height="97" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <th width="141" scope="col" class="p-3 mb-2 bg-success text-white" style="border: none;">
                        <span class="style24">&gt;60</span></th>
                    <th width="205" scope="col" class="p-3 mb-2 bg-success text-white" style="border: none;">
                        &nbsp;</th>
                </tr>
                <tr>
                    <th height="46" scope="col">
                        <table class="sortable" id="anyid23" width="220" cellpadding="0" cellspacing="0"
                            bordercolor="#666666">
                            <tr>
                                <th width="55" class="p-3 mb-2 bg-success text-white"
                                    style="border: 1px solid black;">
                    ...
                    <th colspan="2" scope="col">
                        <table class="sortable" id="anyid24" width="344" cellpadding="0" cellspacing="0"
                            bordercolor="#666666">
                            <tr>
                                <th width="52" class="p-3 mb-2 bg-success text-white"
                                    style="border: 1px solid black;">
