...
<title>توزيع المواليد حسب المستوى التعليمي</title>
...
$stmt_F = oci_parse($c , "begin AGES_BIRTHS.GET_FATHERS_YEARS(:F_DATE_FROM,:F_DATE_TO,:FATHER); end;");
...
$stmt_M= oci_parse($c , "begin AGES_BIRTHS.GET_MOTHERS_YEARS(:M_DATE_FROM,:M_DATE_TO,:MOTHER); end;");
...
<P>
 ...
 <table width="524" border="0" align="center" cellpadding="0" cellspacing="0">
   <tr>
     ...
     <th width="236" scope="col">:توزيع المواليد حسب المستوى التعليمي من تاريخ</th>
   </tr>
 </table>
<P></P>
<table class="sortable"  id="anyid" width="434" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#666666">
   <tr>
     ...
     <th width="195" bgcolor="#91B641"><div align="center"><strong>عدد سنوات الدراسة</strong></div></th>
   </tr>
