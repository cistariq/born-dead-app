...
@section('title', 'حالات الوفاة الغير ممسوحة ضوئيا')
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="float-end">
                        @if (IsPermissionBtn(21))
                            <button type="button" class="btn btn-primary me-5" onclick="get_unscanned_file_rep();">استعلام</button>
                        @endif
...
@push('scripts')
    <script>
        ...
        function get_unscanned_file_rep() {


            var url = "{{ route('Report.get_unscanned_file_rep') }}";
            ...
            buttons: [  {
                        extend: 'excelHtml5',
                        title: 'حالات الوفاة الغير ممسوحة ضوئيا',
                        text:'تحميل ملف اكسل'
