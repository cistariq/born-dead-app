...
$page_name="Daily_Report.php"; //  If you use this code with a different page ( or file ) name then change this 
...
?>
 ...
 <table width="586" border="0" align="center" cellpadding="0" cellspacing="0">
   ...
   <tr>
     ...
     <th width="118" scope="col"><div align="right"><?php echo $dt; echo $date_T;?></div></th>

     <th width="40" scope="col">:الى</th>

     <th width="98" scope="col"><div align="right"><?php echo $df; echo $date_F;?></div>     </th>

     <th width="330" scope="col">:تقارير يومية خاصة بالمواليد من تاريخ الادخال    </th>
   </tr>
	  ...
	  if ($BORN_DETAILS_HEALTH_CENTER_CD2!=0){
		 ...
		 if ($USER_FULL_NAME==$det_user[0]) 
		  ...
		  ?>
			  ...
			  <option value="<?php echo $det_user[0];//$USER_CODE; ?>" <?php echo $selected1; ?>><?php echo  $det_user[1];//$USER_FULL_NAME; ?></option>
 ...
 <table width="972" border="0" align="center" cellpadding="0" cellspacing="0">
   ...
   <tr>
     ...
     <th width="962" scope="col"><table width="948" height="69" border="1" align="left" cellpadding="0" cellspacing="0" bordercolor="#666666"  class="sortable"  id="anyid">
       ...
       <tr>
         <th width="164" height="37" bgcolor="#91B641" ><span class="style13">العنوان</span></th>

         <th width="164" height="37" bgcolor="#91B641" ><div align="center" class="style7">مكان الميلاد</div></th>

         <th width="213" height="37" bgcolor="#91B641"><div align="center" class="style7">اسم الأم رباعي</div></th>

         <th width="219" height="37" bgcolor="#91B641"><div align="center" class="style7">اسم الأب رباعي</div></th>

         <th width="92" height="37" bgcolor="#91B641"><div align="center" class="style7">اسم المولود</div></th>

         <th width="98" height="37" bgcolor="#91B641"><div align="center" class="style7  style11">تاريخ الميلاد</div></th>

         <th width="162" height="37" bgcolor="#91B641"><span class="style13"> هوية المولود</span></th>
	  ...
	  ?>
       ...
       <tr>
         <td height="30" ><div align="right" style=" font-weight:500; font-family:'Times New Roman', Times, serif;font-size:17px" ><?php echo $entry_borns{'BI_ADDRESS_AR'}; ?></div></td>
