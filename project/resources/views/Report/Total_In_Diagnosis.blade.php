...
<div dir="ltr">
    ...
    <body class="st_body">
        <div style="width:1000px; margin:0 auto;" class="text-center">
            ...
            <h3>تقرير بأعداد الوفيات الكلية حسب التشخيص</h3>
        ...
        <div style="width:1000px; margin: auto;" class="text-center">
            ...
            <table width="367" height="29" cellpadding="0" cellspacing="0" bordercolor="#999999">
                <tr>
                    <td width="478" class="p-3 mb-2 bg-success text-white" style="border: none;">
                        <div><strong>الوفيات</strong></div>
                    </td>
                </tr>
            </table>
            <table width="367" cellpadding="0" cellspacing="0">
                <tr>
                    <th width="288" scope="col">
                        <table width="367" cellpadding="0" cellspacing="0" bordercolor="#666666">
                            @php
                          ...
                          //  dd($value);
                            ...
                            <tr>
                                <th scope="col"><span class="style22">{{ $TOT }}</span></th>
                                <th scope="col">العدد الكلي للوفيات المدخلة</th>
                            </tr>
