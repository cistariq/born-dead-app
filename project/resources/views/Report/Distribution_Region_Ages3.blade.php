...
<div dir="ltr">
    ...
    <body class="st_body">
        ...
        <div style="width:1000px; margin: auto;" class="text-center">
            ...
            <table width="346" height="97"   cellpadding="0" cellspacing="0">
                <tr>
                    <th width="200" height="31" scope="col" style="border: none;"
                    class="p-3 mb-2 bg-success text-white"><span class="style24">18-0</span>
                    </th>
                    <th width="156" scope="col" style="border: none;"
                    class="p-3 mb-2 bg-success text-white">&nbsp;</th>
                </tr>
                <tr>
                    <th height="46" colspan="2" scope="col">
                        <table width="356" height="58"  cellpadding="0"
                            cellspacing="0" bordercolor="#666666" class="sortable" id="anyid1">
                            <tr>
