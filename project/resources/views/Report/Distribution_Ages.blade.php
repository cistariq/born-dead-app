...
<title>توزيع المواليد حسب الفئات العمرية في قطاع غزة</title>
...
$stmt_F = oci_parse($c , "begin AGES_BIRTHS.GET_FATHERS_AGES(:F_DATE_FROM,:F_DATE_TO,:FATHER); end;");
...
$stmt_M= oci_parse($c , "begin AGES_BIRTHS.GET_MOTHERS_AGES(:M_DATE_FROM,:M_DATE_TO,:MOTHER); end;");
...
<P>
 ...
 <table width="487" border="0" align="center" cellpadding="0" cellspacing="0">
   <tr>
     ...
     <th width="236" scope="col">:توزيع المواليد حسب الفئات العمرية من تاريخ</th>
   </tr>
 </table>
<P></P>
<table class="sortable"  id="anyid" width="434" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#666666">
   <tr>
     ...
     <th width="195" bgcolor="#91B641"><div align="center"><strong>الفئة العمرية</strong></div></th>
   </tr>
   ...
   <tr>
     ...
     <td width="195"><div align="center"><?PHP echo $entry_F{'PERIOD'}; ?></div></td>
   </tr>
...
<table class="sortable"  id="anyid2" width="434" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#666666">
   ...
   <tr>
     ...
     <td width="195"><div align="center"><?PHP echo $entry_M{'PERIOD'}; ?></div></td>
   </tr>
