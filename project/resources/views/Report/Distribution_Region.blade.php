...
<table width="542" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <th width="236" scope="col">:توزيع تفصيلي للمواليد حسب المحافظات من تاريخ</th>
  </tr>
</table>
<P></P>

<table  width="692" height="29" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#999999">
<tr> 
<td width="574"  bgcolor="#91B641"><div align="center"><strong>المواليد الأحياء </strong></div></td>
 ...
 <table  width="692" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#666666">
   ...
   <p>
     <?php  foreach($list_user as $key=>$det_F){
	 
      $TTOTAL=$TTOTAL+$det_F{'TOTAL'};
	  $TMALE=$TMALE+$det_F{'MALE'};
	  $TFEMALE=$TFEMALE+$det_F{'FEMALE'};
	  
   }
  
   foreach($list_user as $key=>$det_F1){
    $PTOTAL=$det_F1{'TOTAL'}/$TTOTAL*100;
   ?>
   </p>
   <p></p>
   <table class="sortable"  id="anyid2" width="692" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#666666">

   <tr>
     <th width="116" bgcolor="#91B641" class="unsortable"><div align="center"><?PHP echo number_format($PTOTAL,2,'.',''); echo "%";?></div></th>
     <th width="116" bgcolor="#91B641" class="unsortable"><div align="center"><?PHP echo $det_F1{'TOTAL'}; ?></div></th>
     <th width="129" bgcolor="#91B641" class="unsortable"><div align="center"><?PHP echo $det_F1{'FEMALE'}; ?></div></th>
     <th width="124" bgcolor="#91B641" class="unsortable"><div align="center"><?PHP echo $det_F1{'MALE'}; ?></div></th>
     <th width="195" bgcolor="#91B641" ><div align="center"><?PHP echo $det_F1{'C_NAME'}; ?></div></th>
   </tr>
   <?php 
     $R_CODE=$det_F1{'CODE'};
     $curs_D = oci_new_cursor($c);
     $stmt_D = oci_parse($c , "begin DISTRIBUTION_SEX.GET_BORNS_CLINIC_CD(:CODE,:F_DATE_FROM1,:F_DATE_TO1,:SEX1); end;");
   ...
   ?>
   <tr>
     <td width="116"><div align="center"><?PHP echo number_format(($entry_D{'TOTAL'}/$det_F1{'TOTAL'}*100),2,'.',''); echo "%"; ?></div></td>
 ...
 <table  width="692" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#666666">
   ...
   <tr>
     <td width="116">&nbsp;</td>
     <td width="116"><div align="center"><strong><?PHP echo $TTOTAL; ?></strong></div></td>
     <td width="129"><div align="center"><strong><?PHP echo $TFEMALE; ?></strong></div></td>
     <td width="124"><div align="center"><strong><?PHP echo $TMALE; ?></strong></div></td>
