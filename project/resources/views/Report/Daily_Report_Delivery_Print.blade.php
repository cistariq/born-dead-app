...
$stmt_borns1 = oci_parse($c , "begin Daily_Report.GET_SPEC_BORNS_ALL_DELIVERY(:FROM1,:TO1,:DREFF1,:PLACE1,:CENTER1,:EPOINT1,:BORN_INFO); end;");
...
?>
 ...
 <table width="603" border="0" align="center" cellpadding="0" cellspacing="0">
   <tr>
     ...
     <th width="341" scope="col">:تقارير يومية خاصة بالمواليد من تاريخ الولادة </th>
   </tr>
 </table>
<p></p>
...
<p></p>
 <table width="999" border="0" align="center" cellpadding="0" cellspacing="0">
   <tr>
     <th width="971" scope="col"><table width="967" height="84" border="1" align="left" cellpadding="0" cellspacing="0" bordercolor="#666666"  class="sortable"  id="anyid">
       <tr>
	  ...
	  ?>
        <tr>
         <td height="45" ><div align="right" style=" font-weight:500; font-family:'Times New Roman', Times, serif;font-size:17px" ><?php echo $entry_borns{'DREF_NAME_AR'}; ?></div></td>
         <td height="45"><div align="right" style=" font-weight:500; font-family:'Times New Roman', Times, serif;font-size:17px"><?php echo $entry_borns{'MOTHER_FULL_NAME'}; ?></div></td>
         <td width="232" height="45" ><div align="right" style=" font-weight:500; font-family:'Times New Roman', Times, serif;font-size:17px" ><?php echo $entry_borns{'FATHER_FULL_NAME'}; ?></div></td>
         <td height="45" ><div align="center" style=" font-weight:500; font-family:'Times New Roman', Times, serif;font-size:17px" ><?php echo $entry_borns{'BI_FIRST_NAME'}; ?></div></td>
         <td height="45" ><div align="center" style=" font-weight:500; font-family:'Times New Roman', Times, serif;font-size:17px" ><?php echo $entry_borns{'DELIVERY_DATE'}; ?></div></td>
         <td height="45"><div align="center" style=" font-weight:500; font-family:'Times New Roman', Times, serif;font-size:17px"><?php echo $entry_borns{'BI_ID'}; ?></div></td>
        </tr>
     ...
     <th width="185" scope="col"><table width="30" height="77" border="1" align="left" cellpadding="0" cellspacing="0">
       <tr>
	  ...
	  ?>
       <tr>
         <td height="45"><div align="center" style=" font-weight:500; font-family:'Times New Roman', Times, serif;font-size:17px"><?php echo '.'; echo $j ;?></div></td>
       </tr>
       <?php $j=$j+1; }?>
     </table></th>
   </tr>
