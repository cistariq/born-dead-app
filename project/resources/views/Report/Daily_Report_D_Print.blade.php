...
$stmt_F = oci_parse($c , "begin Daily_Report.GET_DEATHS(:ID_NUMBER,:SEX,:DIAG_FROM,:DIAG_TO,:YEAR_FROM,:YEAR_TO,:DATE_FROM,:DATE_TO,:AGE_FROM,:AGE_TO,:PLACE_CD,:HOS_CD,:USER_CD,:POINT_CD,:DEADS); end;");
...
$stmt_F1 = oci_parse($c , "begin Daily_Report.GET_ALL_DEATHS(:ID_NUMBER,:SEX,:DIAG_FROM,:DIAG_TO,:YEAR_FROM,:YEAR_TO,:DATE_FROM,:DATE_TO,:AGE_FROM,:AGE_TO,:PLACE_CD,:HOS_CD,:USER_CD,:POINT_CD,:DEADS); end;");
...
<table width="534" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <th height="60" colspan="4" scope="col"><div style="font-weight:bold; font-size:22px;">تقرير يومي خاص بالوفيات</div></th>
   ...
   <tr>
     ...
     <th width="971" scope="col"><table width="1198" height="93" border="1" align="right" cellpadding="0" cellspacing="0" bordercolor="#666666"  class="sortable"  id="anyid">
       <tr>
         ...
         <th width="109" bgcolor="#91B641" >المسح الضوئي</th>
         <th width="209" height="37" bgcolor="#91B641" ><span class="style13">التشخيص</span>
