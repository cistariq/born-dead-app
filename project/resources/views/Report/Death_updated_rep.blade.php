...
@section('title', 'سجلات الوفاة المعدل عليها حسب تاريخ التعديل')
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="float-end">
                        @if (IsPermissionBtn(21))
                            <button type="button" class="btn btn-primary me-5" onclick="get_updates_file_rep();">استعلام</button>
                        @endif
                ...
                <table id="result_tb3" class="table table-striped table-responsive" style="width:100%">
                    <thead>
                        <tr class="fw-semibold fs-6 text-muted">
                            ...
                            <th scope="col" width="10" style="text-align: center">عدل بواسطة</th>
                            <th scope="col" width="10" style="text-align: center">المسح الضوئي</th>
...
@push('scripts')
    <script>
        ...
        function get_updates_file_rep() {


            var url = "{{ route('Report.get_updated_file_rep') }}";
            ...
            buttons: [  {
                        extend: 'excelHtml5',
                        title: 'سجلات الوفاة المعدل عليها حسب تاريخ التعديل',
                        text:'تحميل ملف اكسل'
