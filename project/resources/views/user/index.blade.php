                                    ...
                                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll"
                                        ...
                                        <div class="fv-row mb-10">
                                            ...
                                            <input class="form-control form-control-lg form-control-solid" type="password"
                                                placeholder="" id="password_confirmation" name="confirm-password"
                                                autocomplete="off" />
                                        </div>
                                        <!--end::Input group=-->
                                    </div>
                                ...
                                <form id="update_user_form" class="form">
                                    ...
                                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_update_user_scroll"
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <select id="u_hospital_id" name="u_hospital_id" data-control="select2"
                                                data-placeholder="اختر ..." data-allow-clear="true"
                                                class="form-select form-select-solid form-select-lg fw-bold">
                                                <option></option>
                                                @foreach ($hospitals as $hospital)
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <label class="form-check form-switch form-check-custom form-check-solid">
                                                ...
                                                <input class="form-check-input ms-10" type="checkbox" value="1"
                                                    id="u_status">
                                            </label>
                                            <!--end::Input-->
                                        </div>
                                    ...
                                    <div class="d-flex flex-column scroll-y me-n7 pe-7"
                                        ...
                                        <div class="fv-row mb-10">
                                            ...
                                            <input class="form-control form-control-lg form-control-solid" type="password"
                                                ...
                                                name="pass_confirm-password" autocomplete="off" />
                                        </div>
                                        <!--end::Input group=-->
                                        <!--begin::Input group-->
                                    </div>
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-200px py-4"
                                    ...
                                    <div class="menu-item px-3">
                                        <a class="menu-link px-3"
                                            onclick="getDataUser({{ $user->id }},'{{ $user->user_full_name }}','{{ $user->user_username }}',{{ $user->status }},{{ $user->hospital_id }})">تعديل</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a class="menu-link px-3"
                                            onclick="ShowChangePassword({{ $user->id }},'{{ $user->user_full_name }}')">تغيير
                                            كلمة المرور</a>
                                    </div>
                                    ...
                                    <div class="menu-item px-3">
                                        <a class="menu-link px-3 text-danger"
                                            onclick="deleteUser({{ $user->id }}, '{{ $user->user_full_name }}')">
                                            حذف المستخدم
                                        </a>
                                    </div>
                                    <!--end::Menu item-->
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.success == 1) {
                                ...
                                Swal.fire('خطأ!', response.results.message, 'error');
                            }
                        },
                        error: function(xhr) {
