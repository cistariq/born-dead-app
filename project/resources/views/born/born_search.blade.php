...
@section('title', 'استعلام إشعارات الولادة')
    ...
    <script>
        ...
        function get_born_data() {
...

            {
                ...
                var url = "{{ route('born.getBornInfo') }}";
        ...
        function update_born_notic(P_BI_CODE) {

var url = "{{ route('born.getBornInfoByCode') }}";
...
$.ajax({
    ...
    if (response.success != true) {
        ...
        Swal.fire({
            title: "هل تريد بالفعل تعديل إشعار الولادة",
            showDenyButton: true,
            ...
            if (result.isConfirmed) {
                var red_url = '{{ route('born.update_born', ':P_BI_CODE') }}';
                red_url = red_url.replace(':P_BI_CODE', P_BI_CODE);
