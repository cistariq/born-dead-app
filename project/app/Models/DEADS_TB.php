...
class DEADS_TB extends Model
{
    ...
    public static function ADD_DEAD_DATA($data)
    {
        ...
        $sql_dead = "begin DEAD_INFO_PKG.ADD_DEAD_TB(:P_ID_NO,:P_ID_TYPE,:P_FIRST_NAME ,:P_FATHER_NAME ,:P_GRAND_FATHER_NAME,:P_FAMILY_NAME,:P_DEAD_HOURS,:P_SEX_CD,
                           ...
                           :P_REPORTER_NATIONALITY_CD,:P_RELATIONSHIP,:P_REPORTER_ADDRESS,:P_REPORTER_MOBILE,:P_RECEIVE_DATE,:P_RECEIVER_NAME,:P_REGISTER_DATE,:P_REGISTER_NAME,:P_REGISTER_PLACE_CD,:P_SOURSE,:P_QR_CD,:P_IS_COMPLETE,:P_DEAD_NUMBER,:P_RESULT,:QR_CODE,:P_ID); end;";
        return DB::transaction(function ($conn) use ($sql_dead, $data) {
            ...
            $stmt->bindParam(':P_IS_COMPLETE', $data['P_IS_COMPLETE'], PDO::PARAM_INT);
    ...
    :P_BIRTH_PLACE,:P_RELEGION_CD,:P_JOB_CD,:P_BURIAL_PLACE,:P_BURIAL_CODE,:P_PREGNANCY_CD,:P_GESTATIONAL_WEEK,:P_AFTER_DELIVERY_CD,:P_PARTNER_ID,:P_PARTNER_NAME,
    :P_DOC_SPECIALIST,:P_DOC_ADDRESS,:P_TREATMENT_DATE,:P_PREVIEW_DATE,:P_SEEING_CORPSE_DATE,:P_CORPSE_DISSECTION_CD,:P_CORPSE_DESSECTION_DATE,:P_REPORTER_SEX_CD,
    :P_REPORTER_NATIONALITY_CD,:P_RELATIONSHIP,:P_REPORTER_ADDRESS,:P_REPORTER_MOBILE,:P_RECEIVE_DATE,:P_RECEIVER_NAME,:P_REGISTER_DATE,:P_REGISTER_NAME,:P_REGISTER_PLACE_CD,:P_COMMITTE_OPINION,:P_SOURCE,:P_UPDATE_REASON,:P_QR_CD,:P_IS_COMPLETE,:P_RESULT); end;";
        return DB::transaction(function ($conn) use ($sql_dead, $data) {
            $lista = [];
            $P_RESULT = 0;
            $P_DEAD_NUMBER = 0;
