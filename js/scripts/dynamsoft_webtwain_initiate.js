...
(function(D) {
    function SWebTwain() {
        ...
        swt._iWidth = 0;        // The width of the main control.
        swt._iHeight = 0;       // The height of the main control.
    ...
    SWebTwain.prototype._createControl = function() {
        ...
        // For non-IE, render the embed object
            ...
            objString += "<embed OnBitmapChanged = 'DynamicWebTwain_OnBitmapChanged' id='" + this._strObjectName + "' style='display: inline; width:" + this._iWidth + "px;height:" + this._iHeight + "px' type='" + D.DWTProduct._strMIMETYPE + "'";
